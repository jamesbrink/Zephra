...
///
/// Under it the run's own seeds: the ones already made, then a place for each still to come.
/// That is the whole reason the strip under the prompt capsule could go — what it showed is
/// here, beside the thing that says how far along it is.
