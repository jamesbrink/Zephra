...
extension ZephraChrome {
    ...
    public static let hoverWash = Color.primary.opacity(0.12)
    /// The fill of a panel that carries a warning.
    public static let warningWash = Color.safelight.opacity(0.12)
    /// The edge of that panel.
    public static let warningStroke = Color.safelight.opacity(0.28)
    ...
    public static let wellFill = Color.primary.opacity(0.06)
    ...
    public static let wellFillHovered = Color.primary.opacity(0.10)
    ...
    public static let wellFillTargeted = Color.accentColor.opacity(0.14)
    ...
    public static let wellDash = Color.secondary.opacity(0.5)
    ...
    public static let captionShadowOpacity: Double = 0.55
}
