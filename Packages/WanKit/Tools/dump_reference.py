...
# ]
# ///
"""Dump reference tensors from the Apache-2.0 diffusers and transformers implementations of
Wan 2.2 TI2V-5B, the model FastWan2.2-TI2V-5B was distilled from.
...
Run with `uv run Tools/dump_reference.py --out Tests/WanTests/Fixtures`.
"""
