...
public nonisolated enum QwenImage21BackendFactory {
    ...
    public static func make(_ environment: InferenceEnvironment) -> BackendFactory {
        { _ in QwenImage21Backend(environment: environment, tile: tile) }
    }

    /// The shared MLX runtime with this family's autoencoder tile behind it. The allocator's
    /// limits and readings are process-wide; only the tile is 2.1's own.
