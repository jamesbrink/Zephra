...
///
/// It lives here rather than in the app because the library searches by it: what a person can
/// read off the inspector is what they will paste into the search box, so the same label has to
/// be in the search key that the interface draws.
extension UInt64 {
