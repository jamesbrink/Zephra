...
extension GenerationStore {
    ...
    /// chosen one, so a switch made mid-run lands as soon as the run is over — unless the
    /// choice is a picture's and waits for Generate, when the loaded model stays.
    func drain() {
