...
public enum SizeEntry {
    ...
    public static func parse(_ text: String, for capabilities: ModelCapabilities) -> ImageSize? {
    ...
    public static func typed(_ text: String) -> ImageSize? {
    ...
    public static func text(_ size: ImageSize) -> String { size.label }

    /// The rule the field follows, for the hint: "Multiples of 32, from 256 to 1024."
    public static func rule(for capabilities: ModelCapabilities) -> String {
