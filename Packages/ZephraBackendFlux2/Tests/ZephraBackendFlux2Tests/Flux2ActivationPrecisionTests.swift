...
struct Flux2ActivationPrecisionTests {
    ...
    func gatesOnTheDevice() {
        ...
        #expect(Flux2ActivationPrecision.resolve(environment: unset, isM5Class: false) == .bfloat16)
        #expect(Flux2ActivationPrecision.resolve(environment: unset, isM5Class: true) == .float32)
    }
